...
<body>
        ...
        <div class="container">
            ...
            <div class="top">
                ...
                <form method="GET" style="width: 100%;">
                    <div class="filter">
                        <input type="text" name="search" placeholder="Cari Pasar"
            ...
            <div class="pagination-wrapper">
                <div class="pagination">
                    {{ $pasar->links('components.pagination') }}
                </div>

                <div class="pagination-info">
                    Showing {{ $pasar->firstItem() }} to {{ $pasar->lastItem() }} of {{ $pasar->total() }} results
                </div>
            </div>
    ...
    <script>
        ...
        function showDetail(
            ...
            const dokumenLink =
                document.getElementById('dokumenLink');

            if(dokumenpasar && dokumenpasar !== '')
            {
                dokumenWrapper.style.display = 'block';

                dokumenLink.href =
                    '/storage/' + dokumenpasar;
            }
            else
            {
                dokumenWrapper.style.display = 'none';
            }
        ...
        let sentraUsaha = @json($pasar ->items());
