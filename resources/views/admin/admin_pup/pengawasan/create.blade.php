...
.form-group input, .form-group select{
    ...
    font-size:14px; outline: none; transition: 0.2s; background-color: white;
}
        ...
        <form action="{{ route('pengawasan.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="jenis_pengawasan" required>
                    ...
                    <option value="Toko Swalayan" {{ old('jenis_pengawasan') == 'Toko Swalayan' ? 'selected' : '' }}>
                        Pengawasan Toko Swalayan
                    </option>
                    <option value="Gudang Minuman Beralkohol" {{ old('jenis_pengawasan') == 'Gudang Minuman Beralkohol' ? 'selected' : '' }}>
            ...
            <div class="form-group">
                <label>Jumlah Yang Diawasi</label>
                <input type="number" name="jumlah" value="{{ old('jumlah') }}" placeholder="Masukkan total lokasi" required>
            </div>
