...
<div class="navbar"><h3>Admin Surat</h3><div>Edit Data Magang</div></div>

<div class="container"><div class="card">
<div class="header"><h2>Edit Data Magang</h2><a href="{{ route('magang.index') }}" class="back">← Kembali</a></div>
