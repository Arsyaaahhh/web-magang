...
<title>Data Penelitian - Sekretariat</title>
...
/* MAIN */
.main{ margin-left:240px; width:calc(100% - 240px); transition: 0.3s ease; }
...
.btn-back-dashboard:hover { background: #5a6268; transition: 0.2s ease; }

.btn-add{ padding:8px 14px; background:#20c997; color:white; border-radius:8px; text-decoration:none; font-weight: 500; font-size: 14px;}
.btn-add:hover { background: #1aa179; transition: 0.2s ease; }

/* Styling Tabel & Action */
.btn-edit{ padding:6px 10px; background:#ffc107; border-radius:6px; text-decoration:none; color:black; font-size: 13px;}
.btn-delete{ padding:6px 10px; background:#dc3545; border-radius:6px; color:white; border:none; cursor:pointer; font-size: 13px;}
.card{ background:white; padding:20px; border-radius:12px; border:1px solid #e5e7eb; }
.table-responsive { overflow-x: auto; }
table{ width:100%; border-collapse:collapse; min-width: 800px; }
th{ background:#eaf2ff; padding:12px; text-align: left; color: #0d6efd; white-space: nowrap;}
...
<div class="main">
    <div class="navbar">
        <div style="display:flex; align-items:center; gap:15px;">
            ...
            <h3 style="color: #333;">Data Penelitian</h3>
        </div>
    ...
    <div class="container">
        <div class="top">
            <h2 style="font-size: 20px; color:#333;">Daftar Mahasiswa Peneliti</h2>
            <div class="top-actions">
                <a href="/admin/admin_sekre" class="btn-back-dashboard"><i class="fas fa-arrow-left"></i> Kembali</a>
                <a href="{{ route('penelitian.create') }}" class="btn-add">+ Tambah Peneliti</a>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex; gap:5px;">
                                    <a href="{{ route('penelitian.edit', $d->id) }}" class="btn-edit">Edit</a>
                                    <a href="{{ route('penelitian.delete', $d->id) }}" class="btn-delete" onclick="return confirm('Hapus data ini?')">Hapus</a>
                                </div>
                            </td>
                        </tr>
                        @empty
                        <tr><td colspan="6" align="center">Belum ada data penelitian</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
