...
<head>
  ...
  <title>Edit Data Alat Ukur</title>
...
<body>
  ...
  <div class="container">
    <div class="card">
      <div class="header">
        <h2>Edit Rekap Alat Ukur</h2>
        <a href="/admin/admin_metro/alat" class="back">← Kembali</a>
      </div>

      <!-- Pastikan route update Anda menggunakan URL ini -->
      <form action="/admin/admin_metro/alat/update/{{ $data->id }}" method="POST">
        @csrf
        <!-- Jika route Anda menggunakan Route::put() di web.php, buka komentar di bawah ini -->
        <!-- @method('PUT') -->
