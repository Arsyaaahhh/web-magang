...
<head>
  ...
  <title>Data Tanda Daftar Reparasi</title>
...
<body>
  ...
  <main>
    ...
    <div class="container">
      <div class="top">
        <h2>Jumlah Tanda Daftar Reparasi (TDR)</h2>
        <div style="display: flex; gap: 10px;">
            <a href="/admin/admin_metro" class="btn btn-back">← Kembali</a>
            <a href="/admin/admin_metro/reparasi/create" class="btn btn-add">+ Tambah Data</a>
        </div>
      </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action">
                        ...
                        <form id="deleteForm{{ $d->id }}" action="/admin/admin_metro/reparasi/delete/{{ $d->id }}" method="POST" style="margin:0;">
                          @csrf @method('DELETE')
