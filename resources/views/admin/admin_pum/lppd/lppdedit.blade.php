...
<body>
  ...
  <div class="container">
    <div class="card">
      ...
      <form action="/admin/admin_pum/lppdupdate/{{ $data->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="form-grid">
          <div>
          ...
          <div><label>Tahun</label><input name="tahun" type="number" value="{{ $data->tahun }}" min="0"></div>
          <div><label>Jumlah</label><input name="jumlah" type="number" value="{{ $data->jumlah }}" min="0"></div>
        </div>
