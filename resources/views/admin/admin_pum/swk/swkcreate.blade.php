      ...
      <form action="/admin/admin_pum/swkstore" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-grid">
          ...
          <div>
            ...
            <input type="number" name="jumlah_pedagang" placeholder="Masukkan Jumlah Pedagang" required min="0">
          </div>

          <div>
            <label>Jumlah Stan</label>
            <input type="number" name="jumlah_stan" placeholder="Masukkan Jumlah Stan" required min="0">
          </div>

          <div>
            <label>Stan Belum Terisi</label>
            <input type="number" name="stan_belum_terisi" placeholder="Masukkan Jumlah Stan Belum Terisi" required min="0">
          </div>
