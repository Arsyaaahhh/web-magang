...
<head>
  ...
  <style>
    * {
    ...
    /* UKURAN KOLOM */
    .pasar-table th:nth-child(1),
    .pasar-table td:nth-child(1){
        width:50px;
        text-align:center;
    }

    .pasar-table th:nth-child(2),
    .pasar-table td:nth-child(2){
        width:140px;
    }

    .pasar-table th:nth-child(3),
    .pasar-table td:nth-child(3){
        width:260px;
    }

    .pasar-table th:nth-child(4),
    .pasar-table td:nth-child(4){
        width:160px;
    }

    .pasar-table th:nth-child(5),
    .pasar-table td:nth-child(5){
        width:160px;
    }

    .pasar-table th:nth-child(6),
    .pasar-table td:nth-child(6),
    .pasar-table th:nth-child(7),
    .pasar-table td:nth-child(7),
    .pasar-table th:nth-child(8),
    .pasar-table td:nth-child(8),
    .pasar-table th:nth-child(9),
    .pasar-table td:nth-child(9),
    .pasar-table th:nth-child(10),
    .pasar-table td:nth-child(10){
        width:110px;
        text-align:center;
    }

    .pasar-table th:nth-child(11),
    .pasar-table td:nth-child(11){
        width:150px;
        text-align:center;
    }
    ...
    @media (max-width: 768px) {
        .sidebar {
            left: -240px; /* Sembunyikan sidebar di kiri */
        }
        .sidebar.active {
            left: 0; /* Munculkan saat ditoggle */
        }
