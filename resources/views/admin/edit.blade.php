...
<label>Bidang</label>
<select name="bidang">
<option value="sekretariat" {{ $data->bidang=='sekretariat'?'selected':'' }}>Sekretariat</option>
<option value="mikro" {{ $data->bidang=='mikro'?'selected':'' }}>UMKM</option>
<option value="perdagangan" {{ $data->bidang=='perdagangan'?'selected':'' }}>Distribusi</option>
<option value="koperasi" {{ $data->bidang=='koperasi'?'selected':'' }}>Koperasi</option>
<option value="pembinaan" {{ $data->bidang=='pembinaan'?'selected':'' }}>Pembinaan</option>
<option value="metrologi" {{ $data->bidang=='metrologi'?'selected':'' }}>Metrologi</option>
</select>
</div>
